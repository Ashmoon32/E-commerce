...
@section('content')
    <div class="max-w-3xl">
        <a href="{{ route('shop.index') }}" class="text-sm text-gray-500 hover:text-black mb-4 inline-block">
            &larr; Back to Shop
        </a>
        ...
        @if($product->image)
            <div class="mb-4">
                <img src="{{ $product->image }}" alt="{{ $product->name }}" class="w-full max-w-md h-auto object-cover border">
            </div>
        @endif
